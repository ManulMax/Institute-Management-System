...
class Classes extends Controller{
    ...
    function sendRescheduleEmail(){
        ...
        $scheduleURL='<a href="'.URL.'Classes/saveReschedule/'.$type.'/'.$batch.'/'.$batchname.'/'.$count.'/'.$day.'/'.$hall.'/'.$startTime.'/'.$endTime.'/'.$startDate.'" style="background-color: #080;font-size: 18px;border: 1px solid #080;padding: 15px;color: #ffffff">Confirm</a>';
        $emailBody = '<html>
                        <body>
                            <div style="color: #000;font-size: 16px">
                                <h4>Hi Isurika Perera! has sent you a new class shedule! </h4>
