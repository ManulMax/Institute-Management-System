...
<div class="row">
  ...
  <div class="headerClass">
    <h2><i class="fa fa-user-o"></i>Update Staff</h2>
...
<script type="text/javascript">
  function promptFunction(staffID){
    var alert = document.getElementById("confirmModal");
    document.getElementById('deleteBtn').href="<?php echo URL; ?>updateStaff/delete/"+staffID;
    alert.style.display = "block";
  }
</script>
