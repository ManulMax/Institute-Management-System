...
input[type=text]:focus, input[type=password]:focus, input[type=date], textarea, input[type=radio], select{
  background-color: #ddd;
  outline: none;
}
...
<div class="row">
  ...
  <div class="header">
	  ...
	  <div class="chip"><img src="<?php echo URL; ?>public/icons/School Director_30px.png" alt="Person" width="96" height="96">Admin Name</div>
  </div>
